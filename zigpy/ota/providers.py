...
class Salus(BaseOtaProvider):
    ...
    async def _load_index(
        ...
        LOGGER.warning(
            "Salus no longer provides OTA updates, please remove it from your"
            " configuration. It will be removed as a valid option in 2025.3.0."
        )

        # To make the function an async generator
        if False:
            yield
